...
namespace ElevenNote.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // Add RoleManager
        #region public ApplicationRoleManager RoleManger
        ...
        private void CreateAdminIfNeeded()
        {
            ...
            {
                // See if the Admi role exists
                if (!RoleManager.RoleExists("Administrator"))
                {
                    // Create the Admin Role (if needed)
                    IdentityRole objAdminRole = new IdentityRole("Adinistrator");
                ...
                UserManager.AddToRole(objNewAdminUser.Id, "Adminstrator");
